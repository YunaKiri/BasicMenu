function promptForKey() {
    return new Promise((resolve, reject) => {
        const promptDialog = new android.app.AlertDialog.Builder(mainActivity);
        const editText = new android.widget.EditText(mainActivity);
        editText.setInputType(android.text.InputType.TYPE_CLASS_TEXT);
        promptDialog.setTitle("Digite a chave:");
        promptDialog.setView(editText);
        promptDialog.setPositiveButton("OK", new android.content.DialogInterface.OnClickListener({
            onClick(dialog, which) {
                const key = editText.getText().toString();
                resolve(key);
            }
        }));
        promptDialog.setNegativeButton("Cancelar", new android.content.DialogInterface.OnClickListener({
            onClick(dialog, which) {
