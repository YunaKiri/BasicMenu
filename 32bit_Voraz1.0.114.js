Java.perform(function () {
    ...
    Java.scheduleOnMainThread(function () {
        ...
        function checkKey(key) {
            const correctKey = "sua_chave_correta_aqui";
            return key === correctKey;
        }

        // Função para exibir a caixa de diálogo de login
        function showLoginDialog() {
            const alertDialog = new AlertDialog.Builder(mainActivity);
            const editText = new EditText(mainActivity);
            alertDialog.setTitle("Digite a chave:");
            ...
            alertDialog.setPositiveButton("Login", new DialogInterface.OnClickListener({
                onClick: function(dialog, which) {
                    ...
                    if (checkKey(key)) {
                        ...
                        Toast.makeText(mainActivity, "Chave incorreta!", Toast.LENGTH_SHORT).show();
                    }
                }
            }));
...
Java.perform(function () {
    ...
    // Endere莽o base para modificar vida e estamina
        ...
        // Mostrar a caixa de diálogo de login ao iniciar a aplicação
        showLoginDialog();
