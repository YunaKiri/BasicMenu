...
Interceptor.attach(morto,{
  ...
  // PLAYER ESTAMINA 
  args[0].add(0x18).readPointer().add(0x1C).writeFloat(50)
...
Interceptor.attach(morto,{
  ...
  // PLAYER ESTAMINA 
  args[0].add(0x18).readPointer().add(0x1C).writeFloat(null)
...
Java.perform(function () {
    ...
    Java.scheduleOnMainThread(function () {
        ...
        menu.createMenuStart("021Moreno", 15, "#FFFFFF")

        //set menu layout color and size

        menu.createMenuLayout("#18122B", 220)
        ...
        menu.createMenuBarTitle("YunaMenu", "#FF00FF")

        //set color of on and off options.

        menu.createMenuOptionsLayout("#00FF00", "#393053")

        //id, name and object with on and off functions

        menu.addOption("option1", "FULL ESTAMINA", option1)


    

        menu.addSeekBar("[BETA OFF]:",1, 1, 100, function (changed, state) {
...
Java.perform(function () {
    ...
    Java.scheduleOnMainThread(function () {
        ...
        menu.addOption("option4", "MENU 2", option4)
